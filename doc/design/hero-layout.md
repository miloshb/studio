...
# ✨ Visual Mockup (Rendered in GitHub)

<div style="padding:48px;background:#F7EFEA;border:1px solid #E8DCCF;text-align:center;">
  <div style="font-family:'Cormorant Garamond', serif;font-size:48px;color:#3A3A3C;margin-bottom:12px;">
    Breathe. Flow. Relax.
  </div>
  <div style="font-family:'Inter', sans-serif;font-size:20px;color:#6E6E73;margin-bottom:24px;">
    Mindful movement for a calm, connected life.
  </div>
  <button style="padding:12px 28px;font-family:'Inter', sans-serif;font-size:16px;background:#CFA79E;color:#3A3A3C;border:none;border-radius:4px;">
    View Schedule
  </button>
</div>
...
# 🧩 Layout Structure (Astro Component)
...
└── Spacing (120–160px top/bottom)
```

---

# 🖼️ Image Integration (Optional)
